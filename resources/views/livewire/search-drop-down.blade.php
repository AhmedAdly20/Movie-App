                ...
                <ul>
                    @foreach ($searchResults as $result)
                        <li class="border-b border-gray-700">
                            <a href="{{ route('movies.show',$result['id']) }}" class="block hover:bg-gray-700 px-3 py-3 flex itemx-center">
                                @if ($result['poster_path'])
                                    <img src="{{ 'https://image.tmdb.org/t/p/w500/'.$result['poster_path'] }}" alt="" class="w-8">
                                @else
